module Authentication
  ...
  included do
    ...
    helper_method :authenticated?, :current_user, :pending_authentication_email
  end
  ...
  # Magic link helpers
  def set_pending_authentication_email(email)
    cookies[:pending_auth_email] = {
      value: email,
      httponly: true,
      same_site: :lax,
  ...
  def clear_pending_authentication_email
